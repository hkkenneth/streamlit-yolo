...
if not os.path.exists('coco.names'):
  urllib.request.urlretrieve('https://github.com/onnx/models/raw/main/vision/object_detection_segmentation/yolov4/dependencies/coco.names?raw=true', filename="coco.names")
  st.write('coco.names downloaded')

if not os.path.exists('yolov4_anchors.txt'):
